class LayingHen
  ...
  # OK Ages the hen one month, and lays 4 eggs if the hen is older than 3 months
  def age!
    @age += 1
    if @age > 3
      4.times { @eggs << Egg.new }
    end
   
   end

  # OK Returns +true+ if the hen has laid any eggs, +false+ otherwise
  def any_eggs?
    !@eggs.empty? 
  end

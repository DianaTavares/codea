...
function cambiarPestanna(pestanas, tab) {
    ...
    pestanna = document.getElementById(tab.id);
    listaPestannas = document.getElementById(tabs.id);

    // Obtiene las divisiones que tienen el contenido de las pestañas.
    cpestanna = document.getElementById('c' + tab.id);
    listacPestannas = document.getElementById('contenido' + tabs.id);
